...
def format_help_message() -> str:
    return "\n".join([
        ...
        "<b>Reference Providers</b>  <i>(used when data is available)</i>",
...
def format_start_message() -> str:
    return "\n".join([
        ...
        "and surface <b>sharp money opportunities and market movement</b> in real time.",
        "",
        "<b>What I do:</b>",
        f"  🐶 Monitor Underdog Fantasy live (every 5 min)",
        f"  📊 Compare against available market data (DK / FD / PrizePicks when present)",
        f"  📈 Detect line movement and market shifts automatically",
        f"  🔔 Alert when qualifying S / A / B tier opportunities appear",
        f"  🗃️ Collect multi-sport data for grading and learning",
        "",
        "<b>Alert format:</b>  🟣 PLAYER PROP MARKET ALERT",
        "  Shows available lines, best line, market consensus, and movement.",
        "  Only providers with real data are shown.",
        "",
        "Use /help to see all commands.",
        "Use /pp_import to manually add PrizePicks data.",
        "",
