*** Begin Patch
*** Add File: bot/tests/test_market_quality_gate.py
+import types
+import pytest
+
...
+
+
+def _mk_decision(tier, rec,
+                 l5=(None,None), l10=(None,None), l20=(None,None), l30=(None,None), season=(None,None)):
...
+    assert reason in ("LOW_MQ_A_contradicted", "LOW_MQ_A_needs_2_strong_supporting_windows")
+
*** End Patch